...
public class Recap {
	...
	public static void main(String[] args) {
		...
		System.out.println("Size off array = " + array.length);

		int[] arr = new int[2];
		arr[0] = 1;
//		arr[2] = 3; // RE: ArrayIndexOutOfBoundsException

		System.out.println("Size off arr = " + arr.length);
		System.out.println(arr[0]);

		// can I add more value to the array later?
//		array={100}; // Fixed in size.. NO

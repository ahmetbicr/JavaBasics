...
//		numbers.add((double)7); // We can do like that
		...
		System.out.println(" -------- Retrieving elements using advanced / enhanced for loop -------- ");
		...
		System.out.println();
		System.out.println(" -------- Printing all values using different iterator -------- ");

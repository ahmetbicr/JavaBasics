...
public class MethodsWithReturnValue {
	...
	public static void main(String[] args) {
		...
		// create a String and based and on the number of characters
		// define whether String is long or short
		...
		// identify define which number is the largest and then define whether this
		// largest number if even or odd
